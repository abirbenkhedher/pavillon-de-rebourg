                        ...
                        <div class="vk-confirmation-info">
                            <div class="col-md-8">
                                <div class="vk-confirmation-left" >
                                    <h2>Bien Venue Chez Pavillon De Ribourg</h2>
                                    <p>Votre compte a été créé avec succes.
                                        Vous pouvez maintenant connecter en quliquant <a href="login.php">ici</a></p>
                                       <p> Si vous avez des questions,n'hésitez pas à nous contacter. Merci!</p>
                                    <ul>
                                        <li>
