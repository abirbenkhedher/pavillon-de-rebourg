                ...
                <div class="row">
                            ...
                            <div class="vk-about-banner-destop">
                                ...
                                <div class="vk-about-banner-caption">
                                    ...
                                    <a href="index.php">Acceuil</a>
                                        ...
                                        <a href="gallery_grid.php">Gallerie</a>
                                    </h3>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="vk-main-iso">
                                <div id="lightgallery">
                                    ...
                                    <div class="col-md-4 item b d e col-sm-6" data-src="../assets/images/rooms/<?=$data['image_annonce'];?>">
                                        <div class="vk-item-img">
                                            <a href=""><img src="../assets/images/rooms/<?=$data['image_annonce'];?>" alt="" class="img-responsive"></a>
                                            <div class="vk-item-caption">
                                                <div class="featured-slider-overlay"></div>
                                                <div class="vk-item-caption-text">
                                                    <h2><?php echo $data['titre_annonce'] ?></h2>
                                                    <h4><?php echo $data['prix_annonce'] ?><span>  Nuit</span></h4>
                                                </div>
                        ...
                        <div class="vk-btn-more">
                            <button type="button" class="btn-more">Voir Plus <i class="fa fa-long-arrow-down" aria-hidden="true"></i></button>
                        </div>
                    </div>
