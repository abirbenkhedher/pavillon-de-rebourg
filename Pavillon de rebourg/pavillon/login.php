...
if ($mess=="error")
{
    echo "<script>alert('Verifier Votre Email et Mot de passe');</script>";
}
$client=$_SESSION['id_client']  ?? '0';
if($client>0){ 
    header('location:rooms_list.php?mess=Vous ete déja connecté');
}
                    ...
                    <div class="vk-about-banner-destop">
                        ...
                        <div class="col-md-4">
                            <div class="vk-room-details-content-right">
                                <h3>Se Connecter</h3>
                                <form action="controller/verifClient.php" method="post" class="form-horizontal">
                                    <div class="form-group"> <!-- Date input -->
                                        <div class="col-md-12">
                                            <label class="control-label">Email</label>
                                            <input class="form-control" type="text" placeholder="Email" name="email_client">
                                    ...
                                    <div class="form-group"> <!-- Date input -->
                                        <div class="col-md-12">
											...
											<input class="form-control" type="password" placeholder="Password" name="motdepasse_client">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="control-label">Vous N'avez Pas un compte ?</label>
                                                     <a href="creer_compte.php"><h3>Creer un Compte Gratuitement</h3><i class="fa fa-caret-right" aria-hidden="true"></i></a>
