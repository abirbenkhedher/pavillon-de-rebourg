                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Ajouter Administrateur</h4>
                                    ...
                                    <form method="post" action="controller/AjoutAdmin.php">
                                        ...
                                        <div class="row mb-4">
                                            <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Nom</label>
                                                <div class="col-sm-9">
                                                    <input type="text" required class="form-control" id="horizontal-firstname-input" name="nom_admin">
                                                </div>
                                        </div>
                                        <div class="row mb-4">
                                            <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Prenom</label>
                                            <div class="col-sm-9">
                                                <input type="text" required class="form-control" id="horizontal-firstname-input" name="prenom_admin">
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                        <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">login</label>
                                        <div class="col-sm-9">
                                            <input type="text" required class="form-control" id="horizontal-firstname-input" name="login_admin">
                                            </div>
                                </div>
                                        <div class="row mb-4">
                                            <label for="horizontal-email-input" class="col-sm-3 col-form-label">Email</label>
                                                            <div class="col-sm-9">
                                                                <input type="email" required class="form-control" id="horizontal-email-input" name="email_admin">
                                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                                            <label for="horizontal-password-input" class="col-sm-3 col-form-label">Mot de passe</label>
                                                            <div class="col-sm-9">
                                                            <input type="password" required class="form-control" id="horizontal-password-input" name="motdepasse_admin">
                                                            </div>
                                        </div>
                                        <div class="row mb-4">
